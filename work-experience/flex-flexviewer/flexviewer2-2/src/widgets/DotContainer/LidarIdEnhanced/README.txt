...
// Emails: didum.abraham@iowa.gov & iusc13@gmail.com
...
3.	Use and distribute to friends but not to be sold for any profit/money
4.	Selling of this software product is forbidden/prohibited
...
A. Use and Geometry DrawTool
	1.	Widget allows end-user an option to choose Geometry draw tool such as map point identify,
...
D. ActionScript Functions and Functionalities
	1.	activateGraphic()
			...
			- myGraphicsLayer
	2.	init()
			- activates graphicslayers
			- instantiates DrawTool Object
	...
	12. hideShowMyGridCols()
			...
			- if true, show it, hide it otherwise
	13. showAll()
