package widgets.DotContainer.WidgetLibrary.gov.iowadot.jetfire.operations {
	...
	public class XmlObjectToRefPost
	{
		...
		//Returned Values
		[Bindable]public var RouteSystem:String = new String();		//RouteDefinition
		
		[Bindable]public var GeographicExtent:String = new String();	//RouteDefinition
		
		[Bindable]public var RouteName:String = new String();				//RouteDescription
		
		[Bindable]public var RouteType:String = new String();				//RouteDescription
		
		[Bindable]public var RouteDirection:String = new String();		//RouteDescription
		
		[Bindable]public var ReferencePost:String = new String();		//ReferencePostPoint
		
		[Bindable]public var Offset:String = new String();			//ReferencePostPoint
		...
		[Bindable]public function get RouteId():int {
			return _vRouteId;
		}
		...
		[Bindable] public function get OffsetType():int {
			return _vOffsetType;
		}
