package widgets.DotContainer.WidgetLibrary.gov.iowadot.jetfire.operations {
	...
	public class LatLongToLrs
	{
		...
		//Returned Values
		[Bindable]public var X:String = new String();
		[Bindable]public var Y:String = new String();
		...
		[Bindable]public function get Lon():Number {
			return _vX;
		}
		...
		[Bindable]public function get Lat():Number{
			return _vY;
		}
