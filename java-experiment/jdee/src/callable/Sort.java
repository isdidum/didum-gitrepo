 ...
 * @description Sort(): concrete class
 */
public class Sort {
	...
	/**
	 * @description Sort(): default constructor
	 */
	public Sort() {
	...
	/**
	 * @description Sort(): specific constructor
	...
	/**
	 * @description descendSort(): accessor - sorts date from high to low (Z-A)
	 * @return z-a sort
	 */
	...
	/**
	 * @description getOddSort(): accessor - sorts odd data from low to high
	...
	/**
	 * @description getEvenSort(): accessor - sorts even data from low to high
	...
	/**
	 * @description findPrime(): mutator - finds prime number
	 */
	...
	/**
	 * @description findMaximum(): accessor - finds maximum value of collected array data
	...
	/**
	 * @description findMinimum(): accessor - finds minimum value of collected array data
	 ...
	 * @description toFixed(): accessor - takes an integer and a string expression to return a fixed precision 
	...
	/**
	 * @Description isNumber(): facilitator - determines if a string is a numeric value<br />
	...
	/**
	 * @Description addToString(): mutator - displays results
	 */
