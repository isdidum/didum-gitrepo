...
/**
 * ReadFile: This program reads any normal text files
 * @author A., Didum
 * @date: October 9, 2012
 */
public class ReadFile {
	...
	/**
	 * setFilePath(): mutator - sets and collects the file path
	...
	/**
	 * getFilePath(): accessor - gets the file path
	...
	/**
	 * getFile(): accessor - returns each individual line of text from text file in an array
